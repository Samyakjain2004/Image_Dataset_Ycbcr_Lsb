...
with open(r"C:\Users\sudhanshu chaudhary\OneDrive\Desktop\YCBCR\runlength\final\extracted_bits.txt", 'r') as f:
    encoded_data = f.read().replace(' ', '').strip()

# Read the processed map binary stream
with open('map.txt2', 'r') as f:
...
# Output the result
xor_output_file = r"C:\Users\sudhanshu chaudhary\OneDrive\Desktop\YCBCR\runlength\final\xordecode2.txt"
